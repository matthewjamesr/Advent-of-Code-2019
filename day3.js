...
function detectCross(line1, line2) {
  ...
  for (i = 0; i < line1.length; i++) {
    for (j = 0; j < line2.length; j++) {
      ...
      l2y = l2[j].y;
      if (l1y == l2y && l1x == l2x) {
				if (Math.abs(l1x) + Math.abs(l1y) < closestCross) {
